...
- The CmpE Faculty Member in the SoP of each accepted candidate is assigned as their Thesis Supervisor and Academic Advisor throughout the Ph.D. study.
...
- If the student had already taken some of these courses but still observes them in the required course list, then they should write directly to the Graduate Studies Coordinator.
...
- Remedial courses have to be completed in at most two successive academic semesters. Note that the Summer term is not counted as an academic semester, but courses can be taken during summer to reduce the course load in academic semesters.
  ...
  - If the student is not registered with the university at the time of the Summer term, then they should contact the secretarial office to register for the Summer term at a discounted tuition rate. If the course grade is CB or higher, then the student needs to contact the Graduate Studies Coordinator so that the courses can be dropped from the remedial course list.

- The student has to pass the remedial courses with a GPA of at least 2.50. Failure in a course or a GPA below 2.50 hinders the student from continuing further studies in CmpE. The GPA for remedial courses is calculated after all remedial courses are taken.
...
- LIMITED CONDITION: If the student is a graduate of a non-thesis M.Sc. program, then CmpE599 and CmpE59A also have to be taken in addition to the above list (Applies to non-thesis M.Sc. program graduates who obtained their degrees before Feb 2013).
...
- Students have to complete 24 credits and 60ECTS from the courses. Half of the course load must be from CmpE5xx and CmpE6xx courses. The remaining load can be filled from all programs provided that the course is related to the thesis work, the advisor approves and the following conditions hold:
...
- QEC decides on the resources (papers, books, etc.) that the candidate should study for the Qualifying Exam.

- The Qualifying exam consists of two parts: Written Exam and Oral Exam. A student is eligible to take the Oral Exam if and only if they pass the Written Exam:

  - **Written Exam:** It is an in-class written exam. The success threshold of this exam is 55/100. The questions stem from the resources provided by the QEC.
...
- If a student fails the Qualifying Exam twice, then they have to leave the program.
...
- The student has to register for their advisor's section of CMPE790: PhD Thesis.

- The student prepares a thesis proposal under the guidance of the Thesis Advisor. The proposal should be passed to TPC at least 15 days before the defense. The student makes an oral presentation of the proposal to TPC. If the proposal is accepted as the thesis topic, the student gets TP as the CmpE 790 grade (Thesis in Progress). Otherwise, they are given an extension of three months to make the necessary changes and defend. If the proposal is not found successful again, then the student has to leave the program.

### Thesis Period

- Once the thesis proposal is accepted, the student starts the PhD thesis. The proposal has to be reported to the Institute.

- The TPC evaluates the thesis progress at most every six months. For this purpose, a written progress report is submitted to the TPC at least one month before the evaluation.

  - If the report is found successful, the student gets a TP grade.

  - If a student gets two consecutive F grades or three non-consecutive F grades, then they have to leave the program.

- TPC has to file a report to the Institute of Graduate Studies at the end of each semester regardless of the presence of a progress report. The report should state the thesis status and the TPC's evaluation of any submitted progress report.
...
- After the defense, TDJ can directly accept the thesis or grant at most six months to the candidate so that they can complete some additional work asked by the TDJ. If the thesis work is still found unsatisfactory after this period, then the student has to leave the program.
