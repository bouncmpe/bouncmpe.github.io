...
| CMPE160 | Nesne Tabanlı Programlamaya Giriş | CMPE150 | 4 ||
...
| CMPE220 | Kesikli Hesaplama Yapıları | --- | 3||
| CMPE250 | Veri Yapıları ve Yordamlar | CMPE160 | 4||
| TK221 | Türkçe I | --- | 2 ||
|||| **20** ||
...
| CMPE230 | Sistem Programlama | CMPE160 | 4 ||
| CMPE240 | Sayısal Sistemler | --- | 4 ||
| CMPE260 | Programlama Dillerinin Prensipleri | CMPE250 | 3 ||
| TK222 | Türkçe II || 2 ||
|||| **20** ||
| <h4>Beşinci Dönem</h4>|
| **Ders Kodu** |**Ders Başlığı** | **Önkoşullar** | **Kredi** | **AKTS** |
| CMPE300 | Algoritma Analizi | CMPE250 | 3 ||
| CMPE322 | İşletim Sistemleri | CMPE250 | 4 ||
| CMPE343 | Bilgisayar Mühendisleri için Olasılık ve İstatistiğe Giriş | MATH101 | 3 ||
| CMPE344 | Bilgisayar Organizasyonu | CMPE240 | 4 ||
| IE310 | Yöneylem Araştırması | MATH201 | 4 ||
| HTR311 | Türkiye Cumhuriyeti Tarihi I  || 2 ||
|||| **20** ||
| <h4>Altıncı Dönem</h4>|
| **Ders Kodu** |**Ders Başlığı** | **Önkoşullar** | **Kredi** | **AKTS** |
| CMPE321 | Veri Tabanı Sistemlerine Giriş | CMPE250 | 4 ||
| CMPE350 | Biçimsel Diller ve Makineler Kuramı | CMPE220 | 3 ||
| CMPE352 | Yazılım Mühendisliği Temelleri | --- | 2 ||
| CMPE362 | Bilgisayar Mühendisleri için Sinyal İşlemeye Giriş | MATH202 | 3 ||
| IE306 | Sistem Benzetimi | CMPE343 | 4 ||
| HTR312 | Türkiye Cumhuriyeti Tarihi II || 2 ||
|||| **18** ||
| <h4>Yedinci Dönem</h4>|
| **Ders Kodu** |**Ders Başlığı** | **Önkoşullar** | **Kredi** | **AKTS** |
| CMPE443 | Gömülü Sistem Tasarım Temelleri | CMPE240 | 4 ||
| CMPE451 | Yazılım Mühendisliğinde Proje Tasarımı | CMPE321, CMPE352 | 2 ||
