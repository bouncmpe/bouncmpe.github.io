...
The development environment includes `hugo` and other helper tools. You can start the development server by running the following command in the terminal:

```bash
hugo server --disableFastRender
```

This command will start the development server and you can access the website at `http://localhost:1313` by default. You can see your local changes in real-time. We highly suggest using the development server to see your changes before submitting a pull request.
